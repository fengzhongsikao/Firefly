...
Debian（原版）
特点就是纯稳定、保守、极简，适合资深玩家、追求从零开始折腾的纯服务器。

Ubuntu
基于 Debian 源码开发，预装驱动、播放器、浏览器、常用软件，桌面体验完整，通用性强。
- 公有云默认镜像首选
...
基于 Debian/Ubuntu 开发，国产桌面 Linux 发行版，视觉风格接近 macOS。
...
Deepin 深度
国内公司开发，桌面美观，办公娱乐工具齐全。

Kali Linux
渗透测试/网络安全专用，基于 Debian。
- 预装数百款安全工具
- 安全工程师、渗透测试人员标配
...
- 支持 Linux 子系统：可一键安装 Ubuntu、CentOS、openSUSE、Deepin 等十余种子系统，便于体验其他发行版或构建隔离的开发/测试环境
